...
function M.segment.initialize_run()
  ...
  -- defined.
  local_temperature_K = get_carrier_gas_temperature()
  -- Get carrier gas pressure, converting Pascals to Torr
  local_pressure_torr = get_carrier_gas_pressure() * 0.007500617
  local MM_USEC__M_S = 1.0e-3  -- (mm/usec)/(m/s)
  local_vx_mm_per_usec = get_ion_x_velocity()
  local_vy_mm_per_usec = get_ion_y_velocity()
  local_vz_mm_per_usec = get_ion_z_velocity()
end
